...
export function AppShell({ children, title, subtitle, breadcrumb }: {
  ...
  return (
    <div className="min-h-dvh bg-surface-muted">
        ...
        <div className="flex h-16 items-center gap-3 px-4 lg:px-6">
          ...
          <Link to="/app/dashboard" className="flex items-center gap-2.5">
            ...
            <div className="hidden min-w-0 leading-tight sm:block">
              <div className="text-sm font-bold">Retailer Portal</div>
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className={`fixed inset-y-0 left-0 top-16 z-20 w-64 transform border-r border-border bg-surface transition-transform lg:translate-x-0 ${open ? "translate-x-0" : "-translate-x-full"}`}>
          <nav className="flex h-[calc(100dvh-4rem)] flex-col gap-1 p-3">
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 rounded-md px-3 py-2.5 text-sm font-medium transition-colors ${
                    active ? "bg-primary text-primary-foreground shadow-elegant" : "text-foreground/80 hover:bg-muted hover:text-foreground"
                  }`}
                >
            ...
            <div className="mt-auto">
              <Link to="/" className="flex items-center gap-3 rounded-md px-3 py-2.5 text-sm font-medium text-foreground/80 hover:bg-muted">
